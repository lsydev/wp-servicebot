...
<div class="wrap">
	...
	<div class="bfwp-admin-box layout-col padded"> 
		...
		<form method="POST" action="options.php">  
			<section>
				<p>You can configure these keys to:</p>
				<ul>
					<li>Enable automatic creation of users for your WordPress site on Stripe customer/subscription create events.</li>
					<li>Enable automatic upgrade / downgrade your WordPress user's role on subscription updates events.</li>
					<li>Enable automatic removal of your WordPress user's role on subscription cancellation events.</li>
				</ul>
