...
<div class="wrap">
	...
	<form method="POST" action="options.php">  
		<section>
			...
			?> 
			<p> Then go to <a target="_blank" href="https://dashboard.stripe.com/<?php echo $live_mode ? '' : 'test/'?>webhooks">https://dashboard.stripe.com/<?php echo $live_mode ? '' : 'test/'?>webhooks</a> to add the handler endpoint.</p>
