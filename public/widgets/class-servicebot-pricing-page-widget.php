...
// The widget class
class Servicebot_Pricing_Page_Widget extends WP_Widget {

	// Main constructor
	public function __construct() {
		parent::__construct(
			'servicebot_pricing_page_widget',
	...
	public function widget( $args, $instance ) {
        ...
        wp_localize_script( 'servicebot_subscription_portal_widget', 
                    ...
                    array(
                        ...
                        'widget'          => 'servicebot-pricing-page-widget',
                        'embed_type'      => 'pricing',
...
function servicebot_register_pricing_page_widget() {
	register_widget( 'Servicebot_Pricing_Page_Widget' );
}
