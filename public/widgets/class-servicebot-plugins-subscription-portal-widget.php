...
// The widget class
class Servicebot_Plugins_Subscription_Portal_Widget extends WP_Widget {

	// Main constructor
	public function __construct() {
		parent::__construct(
			'servicebot_plugins_subscription_portal_widget',
	...
	public function form( $instance ) {
        ...
        <table>
            ...
            <tr>
                <td>Secret Key</td>
                <td><?php print(($this->secret_key) ? "Set!" : "<a href='/wp-admin/admin.php?page=servicebot_plugins'>Settings</a>"); ?></td>
            </tr>
            <tr>
                <td>Service</td>
	...
	public function widget( $args, $instance ) {
        ...
        wp_localize_script( 'servicebot_subscription_portal_widget', 
                            ...
                            array(
                                ...
                                'widget'          => 'servicebot-plugins-subscription-portal-widget',
                                'embed_type'      => 'subscription_portal',
...
function servicebot_register_subscription_portal_widget() {
	register_widget( 'Servicebot_Plugins_Subscription_Portal_Widget' );
}
...
function shortcode_servicebot_subscription_portal_widget($params = array()) {
    ...
    */
    ...
    the_widget( 'Servicebot_Plugins_Subscription_Portal_Widget', $params , array() );
    echo '<!-- /Widget Shortcode -->';
